...
export const MONETIZATION_CONFIG = {
  ...
  crypto: {
    solana: process.env.NEXT_PUBLIC_CRYPTO_SOL_ADDRESS || '7xKXtg2CW87d97TXJSDpbD5jBkheTqA83TZRuJosgAsU',
  ...
  aads: {
    unitId: process.env.NEXT_PUBLIC_AADS_UNIT_ID || '', // e.g. "2345678"
  },
  ...
  affiliates: {
    g2a: process.env.NEXT_PUBLIC_G2A_AFFILIATE_URL || 'https://www.g2a.com',
